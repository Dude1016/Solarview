...
CREATE TABLE `solarsystem` (
  ...
  `planets` varchar(45) DEFAULT NULL,
...
--
-- Dumping data for table `solarsystem`
--

LOCK TABLES `solarsystem` WRITE;
/*!40000 ALTER TABLE `solarsystem` DISABLE KEYS */;
/*!40000 ALTER TABLE `solarsystem` ENABLE KEYS */;
UNLOCK TABLES;
